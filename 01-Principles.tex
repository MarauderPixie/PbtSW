...
\textbf{Never Say Your Move:} because the game starts with and ends with the game fiction, you won’t say ``I use \move{Rock \& Roll} on that guy!'' Instead, determine from what you are doing in the game world (running, shooting, jumping, dying, etc.) what move would apply. When the rolling is done, you conclude with some more fiction (or perhaps the GM does, depending on the outcome). This is the story, not whether you used \move{Rock \& Roll} or \move{Stay Frosty}.

\textbf{Fiction Forces:} if you do something in the game world that would trigger a move, then you \textbf{must} make that move. You can’t say ``I’m diving into the closet to avoid being spotted'' and then not make the \move{Stay Frosty} move. Conversely, you can’t make a move unless the situation actually demands it. If you’re not fighting someone who’s fighting back, then you don’t get to make the \move{Rock \& Roll} move. The game fiction dictates what happens.
...
In this game, the dice rolling revolves around the concept of the Move. When you are instructed to roll dice for a move, your responsibility is simple: roll 2d6, and add the value of a stat (or sometimes some other value) to the result. When a roll is needed, it is usually phrased as \roll{Stat}, where ``Stat'' is the value of your characters stat to add to the roll.

\textbox{Example}{If you are told to \roll{Steady}, you would roll 2d6, sum the total, and add the value of your Steady stat to the result.

Say you're playing a tough Street Samurai with a Hard stat of 2 and a Smooth stat of -1. \move{Roch \& Roll} is your life, so when you \roll{Hard} and get a 2 and a 6 you add 2 more and total for a 10. When you're trying to \move{Seduce} someone, though, and roll two 3s you substract 1, totalling to 5. Hitting people comes easy to you, hitting up on people not so much.}
...
\begin{easylist}
    ...
    # It may be the thing that saves your life when the chips are down. See the \move{Last Chance} move.
\end{easylist}
...
Once a character received 7 Karma, they may use the \move{Advance} move to ``spend'' that Karma to improve their character. If you already have 7 Karma marked, you don’t receive any more Karma until you advance. You're not Buddha and can only learn so much at a time.
...
\begin{easylist}
    ...
    # \textbf{Medium:} nothing out of the ordinary, but somewhat bulky stuff - a big backpack, a helmet, a case for your "musical" instrument of choice; you can not use items with the \textsf{2-hand} or \textsf{obvious} tags, +1 on \move{I've planned for this}
    # \textbf{Heavy:} riot gear, giant bags of money, a golden S-K Bentley Concordat - you get the idea; boosted on \move{I've planned for this}
\end{easylist}
