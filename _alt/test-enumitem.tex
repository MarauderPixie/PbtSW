...
\begin{itemize}[label=\textendash]
    \item \probe{Wahrnehmung}{1}: ein Bett ist aufgewühlter als die anderen, offene Kiste davor
    \item \probe{Wahrnehmung}{4}: auf einem Bett ist ein seltsamer Knick im Blick, wie ein zusammengeklebtes Bild, das leicht verrutscht ist, sieht eine Kante des Bettes leicht versetzt aus
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Raum B}:
        \begin{itemize}
            ...
            \item  Askennen: \probe{Selbstbeherrschung}{2}, sonst 2B Schaden
